...
class ArticleListView(ListView):
    ...
    def get_queryset_cache_key(self):
        """
        Subclass override. Get the cache key of the queryset
        """
...
class AuthorDetailView(ArticleListView):
    ...
    Author details page
    '''
    page_type = 'Author\'s Article Archive'
...
def permission_denied_view(
    ...
    return render(
        request, template_name, {
            'message': 'Oops, you don\'t have permission to access this page, please click on the homepage to see others?', 'statuscode': '403'}, status=403)
