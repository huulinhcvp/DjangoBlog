...
def emailconfirm(request, id, sign):
    ...
    site = get_current_site().domain
    content = '''
     <p>Congratulations, you have successfully bound your email, you can use {type} to log in to this website directly without a password. You are welcome to continue to pay attention to this website, the address is</p>
